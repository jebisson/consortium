...
const fr: Translations = {
  ...
  support: {
    ...
    plansDesc: "Choisissez la banque qui correspond à votre volume,les heures non utilisées restent disponibles.",
    plans: [
      { title: "Banque 10h", hours: "10h", subtitle: "Pour les besoins occasionnels", bullets: ["Incidents ponctuels", "Support utilisateurs de base", "Téléassistance incluse"] },
      { title: "Banque 20h", hours: "20h", subtitle: "Pour un usage régulier", bullets: ["Support réactif prioritaire", "Téléassistance incluse", "Suivi des heures consommées"] },
      { title: "Banque 40h", hours: "40h", subtitle: "Pour les organisations actives", bullets: ["Volume élevé", "Priorité de traitement", "Rapport d'utilisation mensuel"] },
    ],
